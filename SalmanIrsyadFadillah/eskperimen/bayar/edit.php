                ...
                <div class="card-body">
                    ...
                    <form action="../bayar/proses.php" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <small id="emailHelp" class="form-text text-muted">Masukan Kode Pembayaran</small>
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="uang_serangam" value="<?php echo $uang_serangam; ?>">
                            <small id="emailHelp" class="form-text text-muted">Masukan Uang Serangam</small>
                        </div>
                        <br>
                        <div class="form-group">
