            ...
            <div class="card-body">
                ...
                <form action="../daftar/proses.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"><b>Kode Pendaftran</b></label>
                    ...
                    <div class="">
                        ...
                        <label for="exampleInputEmail1" class="form-check-label">Laki-Laki &nbsp;</label>
                        <input type="radio" class="form-check-input" name="jenis_kelamin" value="Perempuan">
                        <label for="exampleInputEmail1" class="form-check-label">Perempuan</label>
                    </div>
                    <br>
