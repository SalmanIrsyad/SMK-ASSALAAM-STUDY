        ...
        <div class="wrapper">
            ...
            <div id="carousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="img/global1.jpg" alt="Carousel Image">
                        <div class="carousel-caption">
                            <h1 class="animated fadeInLeft">Global Warming</h1>
                        </div>
                    </div>
                    <div class="carousel-item">
                        <img src="img/global2.jpg" alt="Carousel Image">
                    </div>
                    <div class="carousel-item">
                        <img src="img/global3.jpg" alt="Carousel Image">
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6">
                            <div class="about-img">
                                <img src="img/global4.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-6">
                            <div class="section-header text-left">
                                <h3>Apa Itu Global Warming?</h3>
                            </div>
                            <div class="about-text">
                                <p>
                                global warming adalah suatu bentuk ketidakseimbangan ekosistem di bumi akibat terjadinya proses peningkatan suhu rata-rata atmosfer, laut, dan daratan di bumi.
                                </p>
                                <p>
                                fenomena peningkatan suhu rata-rata di permukaan bumi. Dalam kurun waktu 100 tahun terakhir ini, suhu bumi meningkat agak cepat, dengan peningkatan rata-rata 0,6 – 0,9 derajat (Riphah, 2015), bumi terasa semakin panas.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="about wow fadeInUp" data-wow-delay="0.1s">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-6">
                            <div class="about-img">
                                <img src="img/mpg.jpg" alt="Image">
                            </div>
                        </div>
                        <div class="col-lg-7 col-md-6">
                            <div class="section-header text-left">
                                <h3>Cara Mengukur Pemanasan Global</h3>
                            </div>
                            <div class="about-text">
                                <p>
                                Tahun 1957 ketika para peneliti yang bekerja pada program penelitian global yaitu International Geophysical Year kemudian mengambil sampel atmosfer dari puncak gunung Mauna Loa di Hawai untuk membuktikan hipotesis mereka.
                                </p>
                                <p>
                                Hasilnya Ternyata kadar CO2 meningkat konsentrasinya di atmosfer dan menyebabkan pemanasan global. Sebenarnya para ilmuwan juga sudah menduga kalau iklim bumi semakin menghangat namun saat itu mereka belum punya cukup bukti untuk memperkuat dugaannya. 
                                </p>
                                <p>
                                    didirikan stasiun cuaca. Letak stasiun cuaca di perkotaan dengan tujuan banyak mendapatkan data dari panas yang dihasilkan dari aktivitas kendaraan dan bangunan. Data yang terkumpul ternyata lebih akurat.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="footer-contact">
                                ...
                                <p><i class="fa fa-envelope"></i>baleanticelurit@gmail.com</p>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-3">
                            <div class="footer-link">
                                <h2>Location</h2>
                                <p><i class="fa fa-map-marker-alt"></i> Chili Street, Bandung, IND</p>
                            </div>
                        </div>
                ...
                <div class="container copyright">
                    <div class="row">
                        <div class="col-md-6">
                            <p>&copy; <a href="#">iNEWS</a>, All Right Reserved.</p>
                        </div>
                        <div class="col-md-6">
                            <p>Designed By iNEWS</a></p>
                        </div>
                    </div>
                </div>
            </div>
