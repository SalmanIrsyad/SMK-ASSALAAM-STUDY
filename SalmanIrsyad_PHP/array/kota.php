...
echo"<h1>ID dan NAME</h1>";
foreach ($pulau as $key) {
    echo "ID : ".$key["id"]."<br>";
    echo "Nama Provinsi : ".$key["name"]."<br><hr>";
    echo "<br>";
}

echo "<br>";
print "<h1>MOVE THE JAWA BARAT,DKI JAKARTA,YOGYAKARTA TO THE TOP</h1>\n" ;
echo "<br>";
move_to_top($pulau, '34');
move_to_top($pulau, '31');
move_to_top($pulau, '32');
foreach ($pulau as $key) {
    echo "ID : ".$key["id"]."<br>";
    echo "Nama Provinsi : ".$key["name"]."<br><hr>";
    echo "<br>";
...
echo "<br>";
print "<h1>MOVE ACEH,SUMATERA BARAT TO THE BUTTOM</h1>\n<br>";
move_to_buttom($pulau,'13');
move_to_buttom($pulau,'11');
foreach ($pulau as $key) {
    echo "ID : ".$key["id"]."<br>";
    echo "Nama Provinsi : ".$key["name"]."<br><hr>";
    echo "<br>";
