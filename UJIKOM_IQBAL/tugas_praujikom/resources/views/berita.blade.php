                        ...
                        <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                            <div class="service-item">
                                <div class="service-img">
                                    ...
                                    <div class="service-overlay">
                                        <p>
                                            Perusakan dan penggundulan hutan bisa menyebabkan pemanasan global. Hal tersebut dikarenakan hutan memiliki beraneka ragam pohon atau tumbuhan yang berfungsi menyerap karbondioksida dan menghasilkan oksigen.
                                        </p>
                                    </div>
                                </div>
                                <div class="service-text">
                                    <h3>Penebangan Hutan</h3>
